    ...
    <div class="comanda">
      <div class="container">
        <div class="comanda-nav">
          <div class="comanda-nav__title">
            <NuxtLink :to="localePath('/')">
              <button class="prew">
                <img src="../assets/images/left2.png" alt="icon">
                <p>{{ $t('back') }}</p>
              </button>
            </NuxtLink>
            <h1 class="title">
          ...
          <div class="comanda-nav__text">
            <p class="text"> {{ $t('team_text1') }} {{ $t('team_text2') }} {{ $t('team_text3') }} {{
              $t('team_text4') }} {{ $t('team_text5') }} </p>
          </div>
        </div>
        <div class="content">
          <div class="swiperComanda">
            <div class="swiperSlideComanda" v-for="user in comandaInfo?.data" :key="user.id">
              <div class="img">
        ...
        <!-- <PrButton class="prBtnBottom" :content="$t('all_comand')"></PrButton> -->
      </div>
    </div>
  ...
  height: 30px;
    ...
    <!-- <div class="comanda">
      <div class="container">
        ...
        <div class="content">
          <div class="swiperComanda">
            <div class="swiperSlideComanda" v-for="item in store.team?.data" :key="item">
              <div class="img">
                <img :src="item.img" alt="img">
              </div>
              <div class="info">
                <p class="title">{{ item.name }}</p>
                <p class="job-name">{{ item.job }}</p>
                <div class="icons">
                  <a :href="item.instagram" class="instagram"><img src="../assets/images/Instagram1.png" alt="icon"></a>
                  <a :href="item.telegram" class="telegram"><img src="../assets/images/Telegram.png" alt="icon"></a>
                  <a :href="item.phone" class="phone"><img src="../assets/images/phone.png" alt="icon"></a>
                </div>
                <TransparentBtn class="trBtn" :transparentBtnContent="$t('baholash')"></TransparentBtn>
              </div>
            </div>
          </div>
        </div>
        <PrButton class="prBtnBottom" content="Увидеть весь список"></PrButton>
      </div>
    </div> -->
